...
class AdminProfileFragment : BaseMvpFragment<AdminProfileContract.View, AdminProfilePresenter>(), AdminProfileContract.View {
    override var presenter: AdminProfilePresenter = AdminProfilePresenter()
